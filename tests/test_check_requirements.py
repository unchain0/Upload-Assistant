...
def test_check_dependencies_skips_requirement_with_nonmatching_marker(tmp_path, monkeypatch, capsys):
    ...
    monkeypatch.setattr("src.check_requirements.__file__", str(source_dir / "check_requirements.py"))
    ...
    monkeypatch.setattr("importlib.metadata.version", missing_pywinpty)
