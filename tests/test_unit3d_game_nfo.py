...
async def test_unit3d_game_trackers_attach_scene_nfo(
    tmp_path: Path, tracker_class: type[Any], tracker_name: str
) -> None:
    nfo_path = (
        tmp_path / "tenoke-scriptorium.master.of.manuscripts.update.v1.2.0.nfo"
    )
...
@pytest.mark.asyncio
async def test_unit3d_game_uses_nfo_from_filelist_when_scene_path_is_missing(
    tmp_path: Path,
) -> None:
