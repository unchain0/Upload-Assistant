...
from src.domain_models.configuration import ApplicationConfiguration, ConfigurationMigration
from src.integrations.configuration import PythonConfigurationRepository
from src.integrations.filesystem.paths import CONFIG_PATH, EXAMPLE_CONFIG_PATH, LEGACY_CONFIG_PATH
...
def build_configuration_service() -> ConfigurationService:
    ...
    return ConfigurationService(
        ...
        explicit_path=Path(explicit_value).expanduser() if explicit_value else None,
    )
