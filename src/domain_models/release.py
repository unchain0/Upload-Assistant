...
class Meta:
    ...
    demographic: str = ""
    defer_zentag_validation: bool = False
    ...
    usenet_archive_name: str = ""
    usenet_prepared_files: list[str] = field(default_factory=list)
    ...
    def set_tracker_ids(self, tracker_ids: Mapping[str, str | int]) -> None:
