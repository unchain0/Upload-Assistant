...
class Args:
    ...
    def parse(self, argv: Sequence[str], meta: Meta) -> tuple[Meta, CustomArgumentParser, list[str]]:
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Source [Blu-ray, BluRay, DVD, DVD5, DVD9, HDDVD, WEB, HDTV, UHDTV, LaserDisc, DCP, RETAIL, SCAN]",
            choices=["Blu-ray", "BluRay", "DVD", "DVD5", "DVD9", "HDDVD", "WEB", "HDTV", "UHDTV", "LaserDisc", "DCP", "RETAIL", "SCAN"],
            dest="manual_source",
        )
        parser.add_argument(
            "-res",
