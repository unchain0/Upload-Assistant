...
from src.domain_models.media_identifiers import (
    parse_tmdb_id as parse_tmdb_id_value,
)
...
from src.services.tracker_catalog_service import (
...
class Args:
    ...
    def parse(
        ...
        parser.add_argument(
            "path",
            nargs="*",
            help="Path to file/directory (in single/double quotes is best)",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="(--queue queue_name) Process an entire folder (files/subfolders) in a queue",
        )
        parser.add_argument(
            "-lq",
            "--limit-queue",
            ...
            nargs=1,
            required=False,
            help="Limit the amount of queue files processed",
            type=int,
            default=0,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="[parse a txt output file from UNIT3D-Upload-Checker]",
        )
        parser.add_argument(
            "-s",
            "--screens",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Comma-separated frame numbers to use as screenshots",
            type=str,
            default=None,
        )
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Public artwork URL or local poster image path",
            dest="explicit_poster",
        )
        parser.add_argument(
            "--banner",
            nargs=1,
            required=False,
            help="Public artwork URL or local banner image path",
            dest="explicit_banner",
        )
        parser.add_argument(
            "-c",
            "--category",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="PODCAST: final tracker title following the site's naming rules",
            dest="podcast_title",
        )
        parser.add_argument(
            "--podcast-cover",
            nargs=1,
            required=False,
            help="PODCAST: local square JPEG cover path",
            dest="podcast_cover",
        )
        parser.add_argument(
            "--podcast-banner",
            nargs=1,
            required=False,
            help="PODCAST: local 16:9 JPEG banner path",
            dest="podcast_banner",
        )
        parser.add_argument(
            "--unwalled-category",
            nargs=1,
            required=False,
            help="Unwalled subject category name or numeric ID",
            dest="unwalled_category",
        )
        parser.add_argument(
            "--unwalled-type",
            nargs=1,
            required=False,
            help="Unwalled upload type name or numeric ID",
            dest="unwalled_type",
        )
        parser.add_argument(
            "--music-artist",
            nargs=1,
            required=False,
            help="MUSIC: main artist(s), separated by &",
            dest="music_artist",
        )
        parser.add_argument(
            "--music-album",
            nargs=1,
            required=False,
            help="MUSIC: album/release title",
            dest="music_album",
        )
        parser.add_argument(
            "--music-media",
        ...
        parser.add_argument(
            ...
            required=False,
            type=int,
            help="MUSIC: concrete release/pressing year (not the original group year)",
            dest="music_release_year",
        )
        parser.add_argument(
            "--music-edition-year",
            nargs=1,
            required=False,
            type=int,
            help="MUSIC: remaster/reissue/edition year",
            dest="music_edition_year",
        )
        parser.add_argument(
            "--music-label",
            nargs=1,
            required=False,
            help="MUSIC: label for this release",
            dest="music_label",
        )
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="MUSIC: catalogue number for this release",
            dest="music_catalogue_number",
        )
        parser.add_argument(
            "--music-genre",
            nargs=1,
            required=False,
            help="MUSIC: comma-separated genre override",
            dest="music_genres",
        )
        parser.add_argument(
            "--music-discogs-id",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="MUSIC: exact Discogs release ID or URL",
            dest="music_discogs_release_id",
        )
        parser.add_argument(
            "--music-discogs-master-id",
            nargs=1,
            required=False,
            help="MUSIC: Discogs master ID or URL",
            dest="music_discogs_master_id",
        )
        parser.add_argument(
            "--no-music-discogs",
            dest="music_discogs_enabled",
            action="store_false",
            default=True,
            help="MUSIC: disable Discogs lookup and metadata",
        )
        parser.add_argument(
            "--music-enrich",
            dest="music_enrichment",
            action="store_true",
            default=None,
            help="MUSIC: enable bounded MusicBrainz enrichment for this run",
        )
        parser.add_argument(
            "--no-music-enrich",
            dest="music_enrichment",
            action="store_false",
            help="MUSIC: disable MusicBrainz enrichment for this run",
        )
        parser.add_argument(
            "-t",
            "--type",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="TMDb ID (use movie/ or tv/ prefix)",
            type=str,
            dest="tmdb_manual",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Comma-separated cast override (takes priority over API metadata)",
            type=str,
            dest="manual_cast",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Do not read or write the persistent metadata cache",
            dest="no_metadata_cache",
        )
        parser.add_argument(
            "-igdb",
            "--igdb",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="This is not an Anime release",
        )
        parser.add_argument(
            "-met",
            ...
            nargs="*",
            required=False,
            help="Set episode title, empty = empty",
            type=str,
            dest="manual_episode_title",
            default=None,
        )
        parser.add_argument(
            "-daily",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Remove Dual-Audio from title",
        )
        parser.add_argument(
            "--no-tag",
            dest="no_tag",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Override the generated release name",
            type=str,
            dest="manual_name",
        )
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Remove Edition from title",
        )
        parser.add_argument(
            "--dual-audio",
            dest="dual_audio",
            action="store_true",
            required=False,
            help="Add Dual-Audio to the title",
        )
        parser.add_argument(
            "-ol",
            "--original-language",
            dest="manual_language",
            nargs=1,
            required=False,
            help="Set original audio language",
        )
        parser.add_argument(
            "-oil",
            "--only-if-languages",
        ...
        parser.add_argument(
            ...
            nargs="*",
            required=False,
            help="Book/Audiobook author name (overrides auto-detected value)",
            type=str,
            dest="book_author",
        )
        parser.add_argument(
            ...
            nargs="*",
            required=False,
            help="Book/Audiobook title (overrides auto-detected value)",
            type=str,
            dest="book_title",
        )
        parser.add_argument(
            ...
            nargs="*",
            required=False,
            help="Audiobook narrator name (overrides auto-detected value)",
            type=str,
            dest="narrator",
        )
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="BOOK: public artwork URL or local cover image path",
            dest="book_cover",
        )
        parser.add_argument(
            "--comic",
            ...
            action="store_true",
            required=False,
            help="Identify the book upload as a Comic",
            dest="comic",
            default=False,
        )
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Identify the book upload as a Manga",
            dest="manga",
            default=False,
        )
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Identify the book upload as a Magazine",
            dest="magazine",
            default=False,
        )
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Identify the book upload as a Newspaper",
            dest="newspaper",
            default=False,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "-mc",
            "--commentary",
            dest="manual_commentary",
            action="store_true",
            required=False,
            help="Manually indicate whether commentary tracks are included",
        )
        parser.add_argument(
            "-sfxs",
            "--sfx-subtitles",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Indicates that extras are included. Mainly used for Blu-rays discs",
        )
        parser.add_argument(
            "-sort",
            "--sorted-filelist",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Search for matching requests on supported trackers",
            default=None,
        )
        parser.add_argument(
            "-sat",
            ...
            action="store_true",
            required=False,
            help="Skip automated qbittorrent client torrent searching",
            default=None,
        )
        parser.add_argument(
            "-onlyID",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Set for CINEMATIK Foreign category",
        )
        parser.add_argument(
            "--opera",
            dest="opera",
            action="store_true",
            required=False,
            help="Set for CINEMATIK Opera & Musical category",
        )
        parser.add_argument(
            "--asian",
            dest="asian",
            action="store_true",
            required=False,
            help="Set for CINEMATIK Asian category",
        )
        parser.add_argument(
            "-disctype",
            "--disctype",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Set when a completely untouched disc at CINEMATIK",
        )
        parser.add_argument(
            "-manual_dvds",
            "--manual_dvds",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Add comma separated keywords e.g. 'keyword, keyword2, etc'",
        )
        parser.add_argument(
            "-kf",
            "--keep-folder",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Contains a Dolby Vision layer converted using dovi_tool (HYBRID)",
        )
        parser.add_argument(
            "-hc",
            "--hardcoded-subs",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Ignore dupes and upload anyway (Skips dupe check)",
            dest="dupe",
        )
        parser.add_argument(
            "-sda",
            ...
            action="store_true",
            required=False,
            help="Don't prompt about dupes, just treat dupes as actual dupes",
            dest="ask_dupe",
        )
        parser.add_argument(
            "-ddc",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Prints the time it takes to upload to each individual site.",
            dest="upload_timer",
        )
        parser.add_argument(
            "-mps",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Use mkbrr for torrent hashing",
        )
        parser.add_argument(
            "-frc",
            "--force-recheck",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Send to drafts (BEYONDHD, LST)",
        )
        parser.add_argument(
            "-mq",
            "--modq",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Enable qBittorrent bandwidth control logic before upload",
            dest="qbit_bandwidth_control",
        )
        parser.add_argument(
            "-qbcrl",
            "--qbit-bw-threshold",
            nargs=1,
            required=False,
            help="qBittorrent bandwidth limit threshold (KB/s)",
            type=int,
            dest="qbit_bandwidth_threshold",
        )
        parser.add_argument(
            "-qbctime",
            "--qbit-bw-time",
            nargs=1,
            required=False,
            help="Time to stay under qBittorrent threshold (seconds)",
            type=int,
            dest="qbit_bandwidth_time",
        )
        parser.add_argument(
            "-uo",
            "--upload-order",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Upload to these trackers, comma separated (--trackers blu,bhd) including manual",
        )
        parser.add_argument(
            "-rtk",
            "--trackers-remove",
        ...
        parser.add_argument(
            ...
            required=False,
            dest="delete_meta",
            help="Delete only meta.json from tmp directory",
        )
        parser.add_argument(
            "-dtmp",
            "--delete-tmp",
            ...
            required=False,
            dest="delete_tmp",
            help="Delete tmp directory for the working file/folder",
        )
        parser.add_argument(
            "-cleanup",
            "--cleanup",
        ...
        parser.add_argument(
            "--infohash", nargs=1, required=False, help="V1 Info Hash"
        )
        parser.add_argument(
            "-ch",
            "--channel",
        ...
        parser.add_argument(
            ...
            nargs=1,
            required=False,
            help="Set exclusive flag on all supported trackers",
            dest="exclusive",
        )
        parser.add_argument(
            "-as",
            ...
            action="store_true",
            required=False,
            help="Generate and upload audio spectrograms",
            dest="audio_spectrogram",
            default=None,
        )
        parser.add_argument(
            "-ast",
        ...
        parser.add_argument(
            ...
            action="store_true",
            required=False,
            help="Upload files to Usenet (NNTP)",
        )
        parser.add_argument(
            "--usenet-subject",
            nargs=1,
            required=False,
            help="Custom subject line for Usenet post",
            type=str,
            dest="usenet_subject",
            default=None,
        )
