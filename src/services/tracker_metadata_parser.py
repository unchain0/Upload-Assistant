...
from src.engines.tracker_description_policy import DescriptionCandidate, add_candidate, description_fingerprint, resolve_description_mode, score_release_name
...
from src.integrations.observability.runtime_support import buffer_console_logs, logger
...
async def prompt_user_for_confirmation(message: str, meta: Meta | None = None) -> bool:
    ...
    try:
        ...
        raise OperationAbortedError("Tracker metadata confirmation was cancelled by the user.") from None
