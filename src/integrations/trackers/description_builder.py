...
class DescriptionBuilder:
    ...
    async def get_tv_info(self, meta: Meta) -> tuple[str, str]:
        ...
        try:
            ...
            overview = str(tvmaze_episode_data.get("overview", "") or meta.overview_meta or "")
    ...
    def format_short_mediainfo_json(mediainfo: dict[str, Any] | None, video_file: str = "") -> str:
        ...
        def format_duration(seconds: str) -> str:
            ...
            whole_seconds, remaining_milliseconds = divmod(remaining_milliseconds, 1000)
    ...
    async def _check_saved_pack_image_links(self, meta: Meta, approved_image_hosts: Sequence[str]) -> dict[str, Any]:
    ...
    async def _handle_discs_and_screenshots(self, meta: Meta, approved_image_hosts: Sequence[str], images: list[dict[str, str]], multi_screens: int) -> str:
        if not images:
            return ""
        try:
    ...
    def tracker_specific_formats(self, tracker: str, description: str) -> str:
        ...
        from src.integrations.trackers.registry import api_trackers as unit3d_trackers
