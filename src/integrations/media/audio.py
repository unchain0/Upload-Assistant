        ...
        if meta.dual_audio:
            ...
            if not meta.is_disc:
                ...
                try:
                    ...
                    has_distinct_language_pair = (eng and orig and orig_lang != "en") or (eng and non_en_non_commentary) or (orig and non_en_non_commentary)
                    if has_distinct_language_pair and len(audio_tracks) > 1 and not meta.no_dual:
                        dual = "Dual-Audio"
